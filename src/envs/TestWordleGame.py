...
class TestWordleGame(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.game = WordleGame(WORD_LIST, ANSWER_LIST, word='apple')
        self.assertEqual(len(self.game.word_list), len(WORD_LIST))
    ...
    def test_play_guess_valid_double_letter(self):
        ...
        self.game = WordleGame(WORD_LIST, ANSWER_LIST, word='plead')
        self.game.play_guess('apple')
        self.assertEqual(self.game.current_guess, 'apple')
        self.assertEqual(self.game.num_guesses, 1)
        self.assertFalse(self.game.is_won)
    ...
    def test_play_guess_not_in_word_list(self):
        '''Test playing a guess that is not in the word list.'''
        self.game = WordleGame(WORD_LIST, ANSWER_LIST, word='apple')
    ...
    def test_is_game_over_max_guesses_reached(self):
        ...
        self.game = WordleGame(WORD_LIST, ANSWER_LIST, word='grape')
        for _ in range(6):
